...
function RoleModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 px-4 py-8">
            ...
            <div className="relative z-10 w-full max-w-lg rounded-[2rem] border border-black/10 bg-white p-6 shadow-[0_30px_80px_rgba(0,0,0,0.2)] sm:p-7">
...
export default function RoleForm({ initialRoles, initialError }: RoleFormProps) {
    ...
    return (
        <>
            <div className="rounded-[2rem] border border-black/8 bg-white shadow-[0_22px_48px_rgba(0,0,0,0.06)]">
                ...
                <div className="grid gap-3 p-4 md:hidden">
                    {roles.length > 0 ? (
                        roles.map((role) => (
                            <article key={role.id} className="rounded-[1.5rem] border border-black/8 bg-[#fafaf8] p-4">
                        ...
                        <div className="rounded-[1.5rem] border border-black/8 bg-[#fafaf8] px-4 py-6 text-center text-sm text-black/55">
                            No hay roles cargados.
                        </div>
                    )}
                </div>
